...
Install as a GemPlugin using gem dependencies: <code>config.gem "acts_as_mailchimp", :source => git://github.com/bgetting/acts_as_mailchimp.git, :version => "~>0.1.2"</code>
